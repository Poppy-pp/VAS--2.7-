...
<template>
	<section>
		...
		<el-dialog :title="titleMonth+'月成本汇总表'" :visible.sync="dialogTableVisible" width="80%">
			<el-table border stripe :max-height="windowOutHeight-250" :data="listData" highlight-current-row  style="width: 100%;">
				<el-table-column type="index" label="序号" width="35" align="center">
				</el-table-column>
				...
				<el-table-column prop="" align="center" label="常规">
					...
					<el-table-column prop="NORMEQUIPCOST" align="center" label="设备成本(元)">
					</el-table-column>
					<el-table-column prop="NORMCARDCOUNT" align="center" label="SIM卡张数">
					</el-table-column>
					<el-table-column prop="NORMCARDCOST" align="center" label="卡成本(元)">
					</el-table-column>
				</el-table-column>
				<el-table-column prop="" align="center" label="保险">
					<el-table-column prop="INSUEQUIPCOUNT" align="center" label="保险台数">
					</el-table-column>
					<el-table-column prop="INSUEQUIPCOST" align="center" label="设备成本(元)">
					</el-table-column>
					<el-table-column prop="INSUCARDCOUNT" align="center" label="SIM卡张数">
					</el-table-column>
					<el-table-column prop="INSUCARDCOST" align="center" label="卡成本(元)">
					</el-table-column>
				</el-table-column>
				<el-table-column prop="" align="center" label="汇总">
					<el-table-column prop="" align="center" label="30M一年卡">
						<el-table-column prop="TOTAL30M" align="center" label="常规"></el-table-column>
						<el-table-column prop="" align="center" label="保险"></el-table-column>
					</el-table-column>
					<el-table-column prop="" align="center" label="计提30M一年卡(2018)">
						<el-table-column prop="TOTAL30M" align="center" label="常规"></el-table-column>
						<el-table-column prop="" align="center" label="保险"></el-table-column>
					</el-table-column>
					<el-table-column prop="TOTALEQUIPCOST" align="center" label="设备成本(元)">
					</el-table-column>
					<el-table-column prop="TOTALCARDCOST" align="center" label="卡成本(元)">
					</el-table-column>
					<el-table-column prop="TOTALINSUCOST" align="center" label="保单成本(元)">
					</el-table-column>
				</el-table-column>
			</el-table>
	...
	export default {
		...
		methods: {
			...
			handleImplement() {
				...
				this.$confirm('此操作将刷新 ' + this.titleMonth + '月【成本汇总表】信息，是否刷新？', '提示', {
