...
<template>
	<section class="tab_content-wrapper">
						...
						<div style="display:inline-block;margin:0 10px 10px 0;">
							<el-input class="noborder color icon nofocus" @keyup.native.ctrl.8="clearAll()" @keyup.native.13="handleQuerySelect" placeholder="请输入查询内容" v-model="filters.domSearch[index].content">
								<el-select class="wp_select" multiple clearable filterable v-model="filters.domSearch[index].select" slot="prepend" placeholder="选择条件">
									<el-option label="代码" value="suppliercode"></el-option>
									<el-option label="名称" value="suppliername"></el-option>
									<el-option label="类型" value="suppliertype"></el-option>
		...
		<el-table :max-height="windowOutHeight-165" stripe border :data="listData" :row-class-name="tableRowClassName" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" @sort-change="sortChange">
			...
			<el-table-column prop="suppliercode" label="代码" align="center" >
			</el-table-column>
			<el-table-column prop="suppliername" label="名称" align="center" >
			</el-table-column>
			<el-table-column prop="suppliertype" label="类型" align="center" >
			</el-table-column>
			<el-table-column prop="supplieraddress" label="地址" align="center" >
			</el-table-column>
			<el-table-column prop="linkman" label="联络人" align="center" >
			</el-table-column>
			<el-table-column prop="contactno" label="联系方式" align="center" >
			</el-table-column>
		...
		<el-col :span="24" class="toolbar">
			<el-pagination @size-change="handleSizeChange" background @current-change="handleCurrentChange" :page-sizes="[15, 50, 80, 100]" :page-size="pageSize" layout="total, sizes, prev, pager, next" :total="total" style="float:right;">
			</el-pagination>
		</el-col>
			...
			<el-tabs>
				...
				<el-row style="padding:10px 40px;margin-bottom:20px;border-bottom:1px solid #C4E8D6;">
					...
					<el-col :span="7">
						<dl class="dllist" style="margin-bottom:10px;">
							<dt>创建日期:</dt>
							<dd>{{supplierThisList.createdate == null ? "暂无" :fmtdata.formatDate.format(new Date(supplierThisList.createdate), 'yyyy-MM-dd') }}</dd>
						</dl>
					</el-col>
					<el-col :span="5">
						<dl class="dllist" style="margin-bottom:10px;">
					...
					<el-col :span="7">
						<dl class="dllist" style="margin-bottom:10px;">
							<dt>修改日期:</dt>
							<dd>{{supplierThisList.updatedate == null ? "暂无" :fmtdata.formatDate.format(new Date(supplierThisList.updatedate), 'yyyy-MM-dd') }}</dd>
						</dl>
					</el-col>
				</el-row>
			</el-tabs>
		...
		<el-dialog title="编辑" :modal-append-to-body="false" :visible.sync="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="100px" :rules="editFormRules" ref="editForm">
				<el-row :gutter="20">
					<el-col :span="12">
						<el-form-item label="代码" prop="suppliercode">
						...
						<el-form-item label="类型" prop="suppliertype">
							<el-input v-model="editForm.suppliertype" auto-complete="off"></el-input>
						</el-form-item>
			...
			<el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm">
				<el-row :gutter="20">
					<el-col :span="12">
						...
						<el-form-item label="类型" prop="suppliertype">
							<el-input v-model="addForm.suppliertype" auto-complete="off"></el-input>
						</el-form-item>
						<el-form-item label="地址" prop="supplieraddress">
...
<script>
	...
	import { getSupplierList, addSupplier, modifySupplier, removeSupplier, getSelectListSupplier,getNamebyUserid } from '../../api/api';
