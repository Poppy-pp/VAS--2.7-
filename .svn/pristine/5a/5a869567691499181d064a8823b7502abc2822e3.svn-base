<template>
	<section class="tab_content-wrapper">
		...
		<el-table border :max-height="windowOutHeight-200" stripe :data="listData" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="reskey" label="代码" align="center">
			</el-table-column>
			<el-table-column prop="restype" label="类型" align="center">
			</el-table-column>
			<el-table-column prop="resurl" label="URL" align="center">
			</el-table-column>
			<el-table-column prop="reslevel" label="级别" align="center">
			</el-table-column>
		...
		<el-dialog title="编辑" :modal-append-to-body="false" :visible.sync="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="代码" prop="reskey">
					<el-input v-model="editForm.reskey" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="类型" prop="restype">
					<el-input v-model="editForm.restype" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="URL" prop="resurl">
					<el-input v-model="editForm.resurl" auto-complete="off"></el-input>
				</el-form-item>
				<el-form-item label="级别" prop="reslevel">
					<el-input v-model="editForm.reslevel" auto-complete="off"></el-input>
				</el-form-item>
...
<script>
	...
	import { getSysResourceInfoList, addSysResourceInfo, modifySysResourceInfo, removeSysResourceInfo, getCustomerInfoList } from '../../api/api';
