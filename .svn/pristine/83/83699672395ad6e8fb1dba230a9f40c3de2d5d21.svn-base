                    ...
                    <el-collapse-item title="保险操作" name="8" class="lefw10">
                        <el-form label-position="top" :model="ruleForm" ref="ruleForm" :rules="rules" class="cur-form-inn" label-width="110px" inline>
                            <el-row :gutter="20">
                                ...
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="万网保单编号" prop="serialnum">
                                        <el-input type="text" v-model="ruleForm.serialnum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="保险服务期限(年)" prop="serialnum">
                                        <el-input type="text" v-model="ruleForm.serialnum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="保险服务费用(元)" prop="serialnum">
                                ...
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="出单客户" prop="serialnum">
                                        <el-input type="text" v-model="ruleForm.serialnum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="出单客户身份证号" prop="serialnum">
                                        <el-input type="text" v-model="ruleForm.serialnum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="出单客户手机号" prop="serialnum">
                                        <el-input type="text" v-model="ruleForm.serialnum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="发动机号" prop="serialnum">
                                        <el-input type="text" v-model="ruleForm.serialnum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="厂牌型号" prop="serialnum">
                                        <el-input type="text" v-model="ruleForm.serialnum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="初登日期" prop="serialnum">
                                       <el-date-picker type="date" placeholder="选择出单日期" v-model="ruleForm.issuedate" style="width: 100%;"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="车牌号" prop="serialnum">
                                        <el-input type="text" v-model="ruleForm.serialnum"></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="8" class="mt20">
                                    <el-form-item label="出单日期" prop="serialnum">
                                        <el-date-picker type="date" placeholder="选择出单日期" v-model="ruleForm.issuedate" style="width: 100%;"></el-date-picker>
                                    </el-form-item>
                                </el-col>
                            </el-row>
                            <el-col class="footer_but_bd" :span="24">
                                <el-button type="primary" @click="submitForm('ruleForm')" :loading="addLoading" style="margin-left:5px;float:right;">出单</el-button>
                                <el-button @click="$router.back(-1)" style="margin-left:5px;float:right;">核保</el-button>
                                <el-button @click="$router.back(-1)" style="margin-left:5px;float:right;">无保险</el-button>
                            </el-col>
                        </el-form>
                    </el-collapse-item>
                </el-collapse>
