<template>
	<section class="tab_content-wrapper">
		...
		<!--列表-->
		<el-table border :data="customers" stripe highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			<el-table-column type="selection" width="55">
			</el-table-column>
			<el-table-column type="index" width="60">
			</el-table-column>
			<el-table-column prop="custname" label="名称" width="100" >
			</el-table-column>
			<el-table-column prop="custtype" label="类型" width="180" >
			</el-table-column>
			<el-table-column prop="userid" label="用户ID" width="150" >
			</el-table-column>
			<el-table-column prop="custsvcid" label="用户SVCID" width="150" >
			</el-table-column>
			<el-table-column prop="aftsalerid" label="SalerID" min-width="200" >
			</el-table-column>
			<el-table-column prop="accountdomain" label="域名账号" min-width="300" >
			</el-table-column>
