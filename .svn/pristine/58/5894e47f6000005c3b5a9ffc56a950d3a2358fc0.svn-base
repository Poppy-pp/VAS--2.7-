<template>
	<section class="login_simple_bac">
		...
		<div class="wrapper">
			<div class="container">
				...
				<el-form class="form" :model="account" :rules="rules" ref="account">
					...
					<div class="sflogin">
						<a class="qq" href="javascript:void(0);" @click="qqLogin">
		...
		<p class="rhesis">决心攀登高山的人，总能找到通往山顶的路</p>
		<!-- 忘记用户密码 start-->
		<el-dialog title="找回密码" :modal-append-to-body="false" :visible.sync="editPswDialogVisible" class="setThemeDialog mw500" @close="forgetClose">
			...
			<el-form label-position="left" label-width="80px" :model="pswForm" ref="pswForm" :rules="pswRules">
				<el-col :span="24" v-if="forgetActive == 1">
