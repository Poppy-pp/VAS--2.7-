(function(a2, aF) {
	...
	(function(c8, cf) {
		...
		cT = ct.setDocument = function(e) {
			...
			cl.find.TAG = db.tagNameNoComments ?
			function(dg, dh) {
			...
			cD = cC(cm.contains) || cm.compareDocumentPosition ?
			function(dh, dg) {
	...
	bI.ajaxSettings.xhr = a2.ActiveXObject ?
	function() {
