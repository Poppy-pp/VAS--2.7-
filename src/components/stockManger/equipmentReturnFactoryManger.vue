...
<template>
	<section class="tab_content-wrapper">
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					...
					<el-button type="primary" @click="addS" icon="el-icon-sort">返厂设备批量入库</el-button>
				</el-form-item>
			</el-form>
		</el-col>
		<!--列表-->
		...
		<el-table border :max-height="windowOutHeight-175" stripe :data="listData" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="" width="80" label="返厂批次" align="center">
			</el-table-column>
			<el-table-column prop="" label="供应商" align="center">
			</el-table-column>
			<el-table-column prop="" label="返厂日期" align="center">
			</el-table-column>
			<el-table-column prop="" label="设备类型" :formatter="dateFormatter1" align="center">
			</el-table-column>
			<el-table-column prop="" label="设备型号" align="center">
			</el-table-column>
			<el-table-column prop="" label="设备编号" align="center">
			</el-table-column>
			<el-table-column prop="" label="通用卡类型" align="center" :formatter="dateFormatterDepuee">
			</el-table-column>
			...
			<el-table-column fixed="right" label="操作" width="160" align="center">
				<template scope="scope">
					<el-button size="small" type="danger" @click="">报废</el-button>
					<el-button size="small" type="primary" @click="">入库</el-button>
				</template>
			</el-table-column>
		</el-table>
		<!--工具条-->
		...
		<!-- 返厂设备批量入库 弹窗  start-->
		<el-dialog title="返厂设备批量入库" :modal-append-to-body="false" :visible.sync="rejectDialogVisible" :close-on-click-modal="false">
			<!-- <el-form :model="addForm" ref="addForm">
				...
				<el-form-item label="需要再次换卡">
				      <el-radio-group v-model="addForm.radio3">
				      <el-radio-button label="是"></el-radio-button>
				      <el-radio-button label="否"></el-radio-button>
				    </el-radio-group>
				</el-form-item>
				<el-form-item label="报废">
					<el-radio-group v-model="addForm.radio4">
				      <el-radio-button label="是"></el-radio-button>
				      <el-radio-button label="否"></el-radio-button>
				    </el-radio-group>
				</el-form-item>
			...
			<!-- <el-col class="footer_but_bd" :span="24">
				...
				<el-button type="primary" @click="addRefuseHandling" :loading="addLoading" style="margin-left:5px;float:right;">确认入库</el-button>
			</el-col> -->
			...
			<div slot="footer" class="dialog-footer">
				<el-button type="primary" @click="stoinSubmit()" :loading="addLoading">提交入库</el-button>
	...
	export default {
		...
		methods: {
			...
			addS(){
				...
				let rnum = util.getTimeAndRandom(4);//生成批号
				this.addForm.batchno = rnum;
			},
			addRefuseHandling() {
				let para = {
