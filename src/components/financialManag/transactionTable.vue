...
<template>
	<section>
		...
		<el-dialog stripe :title="titleMonth+'月异动表'" :visible.sync="dialogTableVisible" width="80%">
			<el-table border :max-height="windowOutHeight-250" :data="listData" highlight-current-row style="width: 100%;">
				...
				<el-table-column prop="VEHICLEUSE" align="center" label="车辆用途">
				</el-table-column>
				<el-table-column prop="CORPNAME" align="center" label="公司名称">
				</el-table-column>
				<el-table-column align="center" label="设备号">
					<el-table-column prop="WIREDNUM" align="center" label="有线"></el-table-column>
					<el-table-column prop="WIRELESSNUM" align="center" label="无线"></el-table-column>
				</el-table-column>
				<el-table-column align="center" label="数量">
					<el-table-column prop="INSUCOUNT" align="center" label="盗抢险"></el-table-column>
					<el-table-column prop="NORMCOUNT" align="center" label="常规"></el-table-column>
				</el-table-column>
				<el-table-column align="center" label="结算价(元)">
					<el-table-column prop="INSUPRICE" align="center" label="盗抢险"></el-table-column>
					<el-table-column prop="NORMPRICE" align="center" label="常规"></el-table-column>
				</el-table-column>
				...
				<el-table-column prop="INSTALLAREA" align="center" label="安装区域">
				</el-table-column>
				...
				<el-table-column align="center" label="保单成本异动">
					<el-table-column prop="" align="center" label="人保"></el-table-column>
					<el-table-column prop="" align="center" label="人寿"></el-table-column>
				</el-table-column>
			</el-table>
	...
	export default {
		...
		methods: {
			...
			handleImplement() {
				...
				this.$confirm('此操作将刷新 ' + this.titleMonth + '月【异动表】信息，是否刷新？', '提示', {
