<template>
	<section class="tab_content-wrapper">
		...
		<!--列表-->
		<el-table border :data="models" stripe highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="updateTime" label="更新时间" min-width="300" >
			</el-table-column>
			<el-table-column prop="metaInfo" label="元数据" min-width="300" >
			</el-table-column>
		...
		methods: {
			...
			getCustomer() {
				...
				getCustomerInfoList(para).then((res) => {
					...
					this.models = res.data.data.records;
