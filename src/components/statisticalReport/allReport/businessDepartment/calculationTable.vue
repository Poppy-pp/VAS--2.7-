	...
	<section>
		...
		<el-table stripe border :data="listData" highlight-current-row v-loading="listLoading" style="width: 100%;" :max-height="windowOutHeight-220" ref="listTable" show-summary>
			...
			<el-table-column :label="filters.month + ' 月应收账款'" align="center">
				<el-table-column prop="" label="传统" align="center"></el-table-column>
				<el-table-column prop="" label="盗抢险" align="center"></el-table-column>
			</el-table-column>
			<el-table-column :label="filters.month + ' 月净回款'" align="center">
				<el-table-column prop="" label="传统" align="center"></el-table-column>
				<el-table-column prop="" label="超出部分" align="center"></el-table-column>
				<el-table-column prop="" label="盗抢险" align="center"></el-table-column>
				<el-table-column prop="" label="超出部分" align="center"></el-table-column>
			</el-table-column>
			<el-table-column label="合作价格" align="center">
				<el-table-column prop="" label="传统" align="center"></el-table-column>
				<el-table-column prop="" label="盗抢险" align="center"></el-table-column>
			</el-table-column>
			...
			<el-table-column prop="" label="保证金" align="center">
			</el-table-column>
			<el-table-column prop="" label="返点" align="center">
			</el-table-column>
			<el-table-column label="底价内提成" align="center">
				<el-table-column prop="" label="传统" align="center"></el-table-column>
				<el-table-column prop="" label="盗抢险" align="center"></el-table-column>
			</el-table-column>
			<el-table-column label="超额提成" align="center">
				<el-table-column prop="" label="传统" align="center"></el-table-column>
				<el-table-column prop="" label="盗抢险" align="center"></el-table-column>
			</el-table-column>
			<el-table-column prop="" label="提成总计" align="center">
			</el-table-column>
		</el-table>
