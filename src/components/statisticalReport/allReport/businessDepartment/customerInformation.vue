...
<template>
	<section>
		...
		<el-table stripe border :data="listData" highlight-current-row style="width: 100%;" :max-height="windowOutHeight-220" ref="listTable" show-summary>
			...
			<el-table-column prop="NOW_STATUS" label="目前状态" align="center">
			</el-table-column>
			<el-table-column prop="CONTACT" label="联系人" align="center">
			</el-table-column>
			<el-table-column prop="CONTACT_NUMBER" label="联系电话" align="center">
			</el-table-column>
			<el-table-column prop="CUST_SITUATION" label="客户情况" align="center">
			</el-table-column>
			<el-table-column :label="week + ' 周销量'" align="center">
				<el-table-column prop="WEEK_SALES_MORN" label="传统" align="center"></el-table-column>
				<el-table-column prop="WEEK_SALES_INSU" label="盗抢险" align="center"></el-table-column>
			</el-table-column>
			<el-table-column :label="filters.month + ' 月销量'" align="center">
				<el-table-column prop="MONTH_SALES_MORN" label="传统" align="center"></el-table-column>
				<el-table-column prop="MONTH_SALES_INSU" label="盗抢险" align="center"></el-table-column>
			</el-table-column>
			<el-table-column  :label="filters.month + ' 月应收账款'" align="center">
				<el-table-column prop="MONTH_GATHER_MORN" label="传统" align="center"></el-table-column>
				<el-table-column prop="MONTH_GATHER_INSU" label="盗抢险" align="center"></el-table-column>
			</el-table-column>
		</el-table>
...
<script>
	...
	export default {
		...
		methods: {
			...
			/*导出*/
			handleExport() {
				window.location.href = '/vasms-web/api/v1/bi/biViewNameAll/exportTo?_viewName=合作客户信息表&token=' + this.$store.getters.userInfo.token + '&BUSINESS_DATE=' + this.filters.recMonth + '&showCount=' + 20000;
			},
			// 重置
			resetForm(){
		                this.filters = {
