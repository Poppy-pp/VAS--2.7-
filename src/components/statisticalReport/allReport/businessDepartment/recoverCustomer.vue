...
<template>
	<section>
		...
		<el-table stripe border :data="listData" highlight-current-row v-loading="listLoading" style="width: 100%;" :max-height="windowOutHeight-220" ref="listTable" show-summary>
			...
			<el-table-column prop="" label="前业务员" align="center">
			</el-table-column>
			<el-table-column prop="" label="客户情况" align="center">
			</el-table-column>
			<el-table-column prop="" label="开始更进时间" align="center" :formatter="dateFormatter1">
			</el-table-column>
			<el-table-column prop="" label="合作/报价价格" align="center">
			</el-table-column>
			<el-table-column prop="" label="后续更进时间及情况" align="center">
			</el-table-column>
		</el-table>
