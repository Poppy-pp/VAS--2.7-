...
<template>
	<section class="tab_content-wrapper">
		<el-tabs v-model="activeName">
			<el-tab-pane label="维修报单" class="newForm_s" name="bd">
				<div class="newForm_s_col_1">
					<el-steps :space="120" process-status="finish" direction="vertical" :active="active" finish-status="success" style="margin: 20px 0;">
					...
					<div class="text item">
						<section class="myorderFF">
							<keep-alive :include="dynamicRouting">
								<router-view @changeStep="changeStep" @getFormData="getFormData" :store="store" :ruleFormStatic="ruleFormStatic" :curTaskId="curTaskId" ref="proCusum">
								</router-view>
							</keep-alive>
						</section>
					</div>
...
<script>
	...
	export default {
		...
		created() {
			//需要缓存的组件name
			this.dynamicRouting = ['customerService'];
		}
	}
</script>