        ...
        methods: {
            ...
            initFormNum(){
                ...
                getFormCount(para).then((res) => {
                    ...
                    // this.fromNum.num2 = node.proc_new_build_node_send == undefined ? node.node_send : node.node_send + node.proc_new_build_node_send;
                    // this.fromNum.num3 = node.node_work == undefined ? node.proc_new_build_node_work : node.proc_new_build_node_work + node.node_work;
                    ...
                    // this.fromNum.num5 = node.proc_new_build_node_insurance == undefined  ? node.node_insurance : node.proc_new_build_node_insurance + node.node_insurance;
