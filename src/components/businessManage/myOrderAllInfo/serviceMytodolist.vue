...
<script>
    ...
    import {getTodoInfoList,getvariablesSeaviceTaskInfoList,getCorpNameList,getFormCount,addApprovaperSendVindicate,addApprovaperWork,addApprovaperServiceVerify,searchCorpNameList,getDeptManagerInfoList,getOperationRecord,addApprovaperVindicateCl,getFaultReason,getPdInstallUserList,cldeviceIsOnstate} from '../../../api/api';
    export default {
        props:['windowOutHeight'],
        components:{clerkOrder,dialogEquipmentInstall,gdmap3},
        data() {
            return {
                expandLoading:false,
                util:util,
